...
export default function Hero() {
  return (
    <div className="grid grid-cols-1 md:grid-cols-2 mx-auto max-w-325 w-[90%] py-15">
      <div className="flex flex-col justify-center gap-4">
        ...
        <div className="flex gap-4">
            <button className="px-4 py-2 text-white font-medium bg-linear-to-r from-fuchsia-500 to-pink-500 rounded-lg">Explore Technologies</button>
